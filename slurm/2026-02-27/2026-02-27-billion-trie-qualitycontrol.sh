...
################################################################################
HSTRAT_CONTAINER="docker://ghcr.io/mmore500/hstrat:v1.21.7"
...
real_sources = [
    "${HOME}/2026-02-27/a=fossils+flavor=purifying+ext=.pqt",
    "${HOME}/2026-02-27/a=fossils+flavor=sweeping+ext=.pqt",
]
