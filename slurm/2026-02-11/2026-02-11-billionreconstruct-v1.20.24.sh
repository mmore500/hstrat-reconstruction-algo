...
real_sources = [
    "${HOME}/2026-02-11/a=fossils+flavor=genome_purifyingonly+seed=1+ncycle=5000000+ext=.pqt",
    "${HOME}/2026-02-11/a=fossils+flavor=genome_purifyingplus+seed=2+ncycle=5000000+ext=.pqt",
]
