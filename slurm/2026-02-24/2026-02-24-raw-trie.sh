...
container="docker://ghcr.io/mmore500/hstrat@sha256:21adadc4f37e083afc07696a9c2e5f8a37cad3534be9dfee85bedb5fc4a8d530"
...
for phylo_path in "${BATCHDIR}"/__*/**/a=phylo+ext=.pqt; do
    ...
    echo "/tmp/\${SLURM_JOB_ID:-nojid}.pqt" \
        | singularity run docker://ghcr.io/mmore500/hstrat@sha256:21adadc4f37e083afc07696a9c2e5f8a37cad3534be9dfee85bedb5fc4a8d530 \
    ...
    singularity exec docker://ghcr.io/mmore500/hstrat@sha256:21adadc4f37e083afc07696a9c2e5f8a37cad3534be9dfee85bedb5fc4a8d530 \
