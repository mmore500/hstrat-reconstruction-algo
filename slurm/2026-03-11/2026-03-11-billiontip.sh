...
PHYLOFRAME_CONTAINER="docker://ghcr.io/mmore500/phyloframe:v0.2.0"
...
real_sources = [
    "${HOME}/2026-03-10/a=fossils+flavor=pure+ext=.pqt",
    "${HOME}/2026-03-10/a=fossils+flavor=plus+ext=.pqt",
]
