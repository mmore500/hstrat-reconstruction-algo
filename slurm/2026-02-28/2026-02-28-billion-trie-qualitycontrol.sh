...
################################################################################
HSTRAT_CONTAINER="docker://ghcr.io/mmore500/hstrat:v1.21.9"
...
real_sources = [
    "${HOME}/2026-02-28/a=fossils+flavor=purifying+ext=.pqt",
    "${HOME}/2026-02-28/a=fossils+flavor=sweeping+ext=.pqt",
]
