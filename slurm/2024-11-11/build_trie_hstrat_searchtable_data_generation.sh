...
HSTRAT_REVISION="4fbb717213c63350bd306606323bf11e40465589"
...
def load_csv(file_url):
    ...
    # Add a new column to indicate the selection type, easier to understand graphs
...
# Function to benchmark the `build_tree_searchtable`
def benchmark_build_tree_searchtable(population, repetitions=10, selection_type=""):
...
for file_url in csv_files:
    ...
    results += benchmark_build_tree_searchtable(population, selection_type=selection_type)
