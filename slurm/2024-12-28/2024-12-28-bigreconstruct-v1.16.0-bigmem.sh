...
reconst_outpath="\${MYLOCAL}/trie.pqt"
...
stdbuf -e0 -i0 -o0 echo "/local/\$(basename "\${reconst_outpath}")" \
    | stdbuf -e0 -i0 -o0 singularity exec \${container} \
...
cp "\${reconst_outpath}" "\${JOBDIR}/a=trie+ext=.pqt"
