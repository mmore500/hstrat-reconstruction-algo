...
\subsection{End-to-end Phylogeny Reconstruction Pipeline Implementation}
\label{sec:pipeline}
...
Scaling behavior experiments used a C++ implementation of the shortcut-enabled trie-building algorithm.
