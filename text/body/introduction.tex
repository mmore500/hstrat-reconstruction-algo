...
In this work, we present a novel trie-building algorithm that greatly reduces compute time to reconstruct phylogenies from special-purpose markers on digital genomes, while producing equivalent results compared to a naive approach.
